...
<div id="node-<?php print $node->nid; ?>" class="blog-details <?php print $classes; ?> clearfix"<?php print $attributes; ?>>
  ...
  <div class="media_element">
    ...
    <?php else: ?>
    <?php print render($content['field_immagine_film']);?>
    <?php endif;?>
  </div>
  <!-- End media blog -->
  ...
  <div class="blog-detail">
		<div class="blog-content blog-right">
			...
			<div class="blog-decs">
				...
				<span><a href="<?php print $node_url;?>" class="readmore"><?php print t('...'); ?></a></span>
				</p>
			</div>

		  <!-- Begin ADSENSE region!-->
