...
<div id="node-<?php print $node->nid; ?>" class="blog-details <?php print $classes; ?> clearfix"<?php print $attributes; ?>>
  ...
  <div class="media_element">
    ...
    <?php else: ?>
    <?php print render($content['field_image_libro']);?>
    <?php endif;?>
  </div>
  <!-- End media blog -->
	...
	<div class="blog-detail">
		<div class="blog-content blog-right">
			...
			<div class="blog-decs">
				...
				<p><?php print render($content['field_autore_libro']);?></p>
				<p><?php print render($content['field_illustratore_libro']);?></p>
				<p><?php print render($content['field_editore_libro']);?></p>
				<p><?php print render($content['field_buy_libro']);?></p>
			</div>
		  ...
		  <div class="authorbox_wrapper clearfix">
				...
				<?php 
				  ...
				  if (module_exists('profile2')) {  
					 ...
					 if (isset($profile->field_bio['und'][0]['value'])) {
						print ($profile->field_bio['und'][0]['value']);
					 }
				  }
				  ?>  
				</p>
