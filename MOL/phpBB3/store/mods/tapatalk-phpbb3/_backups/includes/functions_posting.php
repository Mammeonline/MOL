...
*/
function submit_post($mode, $subject, $username, $topic_type, &$poll, &$data, $update_message = true, $update_search_index = true, $user_email = false)
{
	...
	switch ($post_mode)
	{
		...
		case 'reply':
			$sql_data[POSTS_TABLE]['sql'] = array(
				...
				'post_user_email'	=> (!$user->data['is_registered']) ? $user_email : '',
